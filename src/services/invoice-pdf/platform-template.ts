  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .plan { display: grid; grid-template-columns: 1fr repeat(5, auto); gap: 20px; margin-bottom: 14px; padding: 14px 16px; border: 1px solid #cbd9e4; border-radius: 14px; background: rgba(255,255,255,.72); }
