...
export function ResidencyCreateFields() {
  return <>
    ...
    <div className="form-grid two"><div className="field"><label htmlFor="residency-tier">Tier</label><select id="residency-tier" name="tier"><option value="operations_only">Platform</option><option value="complete">Full Programming</option></select></div><div className="field"><label htmlFor="residency-invoice-prefix">Invoice prefix</label><input id="residency-invoice-prefix" name="invoicePrefix" placeholder="HOTEL" maxLength={12} required /></div></div>
