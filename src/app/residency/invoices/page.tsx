...
export default async function ResidencyInvoicesPage() {
  ...
  return <>
    <header className="page-header card"><div><p className="eyebrow">Residency billing</p><h1>Invoices</h1><p className="subhead">Approved, sent, and paid invoices. Internal talent cost and margin are never shown here.</p></div></header>
