...
export function AddClientArtistForm() {
  ...
  return <section className="card client-add-artist">
    ...
    <form action={action}>
      ...
      <div className="field"><label htmlFor="client-artist-market">Home market <span>(optional)</span></label><input id="client-artist-market" name="homeMarket" maxLength={200} placeholder="Palm Springs, Los Angeles…" /></div>
      <div className="field"><label htmlFor="client-artist-instagram">Instagram <span>(optional)</span></label><input id="client-artist-instagram" name="instagramHandle" maxLength={160} placeholder="@handle" /></div>
