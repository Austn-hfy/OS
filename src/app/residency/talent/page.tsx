...
export default async function ResidencyTalentPage() {
  ...
  return <>
    <header className="page-header card"><div><p className="eyebrow">Available talent</p><h1>Talent roster</h1><p className="subhead">Shared HFY talent plus artists exclusive to {actor.residencyName}.</p></div></header>
