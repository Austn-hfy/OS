...
export default async function ResidencyPayoutStatusPage() {
  ...
  return <>
    <header className="page-header client-page-header"><div><p className="eyebrow">Your money</p><h1>Payment Status</h1></div><div className="client-owed-total client-page-header-stat"><span>Running total owed</span><strong>{money(owedTotalCents)}</strong></div></header>
