...
export default async function ResidencyPayoutStatusPage() {
  ...
  return <>
    <header className="page-header card"><div><p className="eyebrow">Residency view</p><h1>Payment Status</h1><p className="subhead">Payment status only. Talent rates and payout amounts are not included.</p></div></header>
