  ...
  return <WorkspaceSurface className="residency-workspace-surface workspace-surface-settings workspace-surface-platform-billing">
    ...
    {subscription ? <>
      ...
      <section className="card platform-plan-and-usage">
        <header className="platform-plan-and-usage-title"><h2>Plan &amp; usage</h2></header>
        <div className="platform-committed-plan-section">
          <div className="platform-plan-section-heading">
            <div><p className="eyebrow">Committed Plan</p><h3>Subscription details</h3><p>Live Usage is tracked separately and never changes this bill automatically.</p></div>
