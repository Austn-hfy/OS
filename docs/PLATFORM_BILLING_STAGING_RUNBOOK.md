...
Apply `drizzle/0045_platform_billing_system.sql` before deploying the application. The billing migration was originally authored as 0042, but main's shift-change-request migrations now occupy 0042–0044, so the billing system begins at 0045. It:
